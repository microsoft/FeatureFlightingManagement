...
namespace Microsoft.FeatureFlighting.Tests.Functional.Functional_Test
{
    ...
    public class ActivateStageTest
    {
        ...
        public async Task Verify_ActiveStage_returns_204_for_correct_env_correct_app_to_user()
        {
            ...
            //Act
            var result = await flightingClient.ActivateStage(app, environment,featureName, "stg1");
            //Assert
        ...
        public async Task Verify_ActiveStage_returns_404_for_correct_env_incorrect_app_to_user()
        {
            //Arrange
            ...
            //Act
            var result = await flightingClient.ActivateStage("INVALID", environment, featureName, "stg1");
        ...
        public async Task Verify_ActiveStage_returns_400_for_correct_env_null_app_to_user()
        {
            ...
            string featureName = _testContext.Properties["FunctionalTest:FlagName"].ToString();
            //Act
            var result = await flightingClient.ActivateStage(null, environment, featureName, "stg1");
            //Assert
        ...
        public async Task Verify_ActiveStage_returns_404_for_incorrect_flag_correct_env_correct_app_to_user()
        {
            //Arrange
            FeatureFlagClient flightingClient = ClientCreator.CreateFeatureFlagClient(_testContext);
            string environment = _testContext.Properties["FunctionalTest:Application:Environment"].ToString();
            ...
            //Act
            var result = await flightingClient.ActivateStage(app, environment, "Invalid", "stg1");
            //Assert
            Assert.AreEqual(HttpStatusCode.NotFound.ToString(), result);
        }
    }
