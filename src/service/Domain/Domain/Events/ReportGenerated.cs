    ...
    public class ReportGenerated : Event
    {
        ...
        public Dictionary<string, string> CreateProperties()
        {
            return new Dictionary<string, string>
            {
                ...
                { "ActiveFeatureNames", Report.ActiveFeatures != null ? string.Join(',', Report.ActiveFeatures) : "N/A" },
                { "ActiveFeaturesCount", Report.ActiveFeaturesCount.ToString() },
                { "NewlyAddedFeatureNames", Report.NewlyAddedFeatures != null ? string.Join(',', Report.NewlyAddedFeatures) : "N/A" },
                { "NewlyAddedFeaturesCount", Report.NewAddedFeaturesCount.ToString() },
                { "UnusedFeatureNames", Report.UnusedFeatures != null ? string.Join(',', Report.UnusedFeatures.Select(feature => feature.FeatureId) ) : "N/A" },
                { "LongInactiveFeatureNames", Report.LongInactiveFeatures != null ? string.Join(',', Report.LongInactiveFeatures.Select(feature => feature.FeatureId) ): "N/A" },
                { "LongActiveFeatureNames", Report.LongActiveFeatures != null ? string.Join(',', Report.LongActiveFeatures.Select(feature => feature.FeatureId) ) : "N/A" },
