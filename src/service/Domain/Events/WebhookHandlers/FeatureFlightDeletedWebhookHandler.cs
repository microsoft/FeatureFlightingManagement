...
namespace Microsoft.FeatureFlighting.Core.Events.WebhookHandlers
{
    internal class FeatureFlightDeletedWebhookHandler : BaseFeatureFlightWebhookEventHandler<FeatureFlightDeleted>
    {
        ...
        public FeatureFlightDeletedWebhookHandler(ITenantConfigurationProvider tenantConfigurationProvider, IWebhookTriggerManager webhookTriggerManager, IConfiguration emailConfiguration, ILogger logger)
