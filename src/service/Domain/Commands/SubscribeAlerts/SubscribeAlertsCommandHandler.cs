...
{
    /// <summary>
    /// Handles <see cref="SubscribeAlertsCommand"/>
    /// </summary>
    public class SubscribeAlertsCommandHandler : CommandHandler<SubscribeAlertsCommand, IdCommandResult>
    {
        ...
        public SubscribeAlertsCommandHandler(ITenantConfigurationProvider tenantConfigurationProvider,
        ...
        protected override async Task<IdCommandResult> ProcessRequest(SubscribeAlertsCommand command)
        {
            ...
            flight.Subscribe(_identityContext.GetCurrentUserPrincipalName(), command.Source, command.TrackingIds);
        ...
        private async Task<FeatureFlightAggregateRoot> GetFeatureFlight(SubscribeAlertsCommand command, TenantConfiguration tenantConfiguration)
        {
