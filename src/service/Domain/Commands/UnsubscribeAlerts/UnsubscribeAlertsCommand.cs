...
{
    /// <summary>
    /// Command to unsubscribe alers for the feature flight
    /// </summary>
    public class UnsubscribeAlertsCommand: Command<IdCommandResult>
    {
        public override string DisplayName => nameof(UnsubscribeAlertsCommand);
        ...
        public UnsubscribeAlertsCommand(string featureName, string tenant, string environment, string correlationId, string transactionId, string source)
        {
