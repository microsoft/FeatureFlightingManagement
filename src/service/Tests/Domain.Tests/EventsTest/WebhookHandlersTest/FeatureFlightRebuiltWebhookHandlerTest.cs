...
namespace Microsoft.PS.FlightingService.Core.Tests.EventsTest.WebhookHandlersTest
{
    ...
    [TestClass]
    public class FeatureFlightRebuiltWebhookHandlerTest
    {
        ...
        private FeatureFlightRebuiltWebhookHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new FeatureFlightRebuiltWebhookHandler(_mockTenantConfigurationProvider.Object, _mockWebhookTriggerManager.Object, _mockConfiguration, _mockLogger.Object);
        }

        [TestMethod]
        public async Task Handle_ShouldTriggerWebhook()
        {
            var testEvent = GetFeatureFlightRebuilt();
        ...
        private FeatureFlightRebuilt GetFeatureFlightRebuilt()
        {
