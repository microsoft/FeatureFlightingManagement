...
namespace Microsoft.PS.FlightingService.Core.Tests.EventsTest.WebhookHandlersTest
{
    ...
    public class FeatureFlightAlertsEnabledWebhookHandlerTest
    {
        ...
        public void SetUp()
        {
            ...
            _handler = new FeatureFlightAlertsEnabledWebhookHandler(_mockTenantConfigurationProvider.Object, _mockWebhookTriggerManager.Object, _mockConfiguration, _mockLogger.Object);
        }
