...
namespace Microsoft.PS.FlightingService.Core.Tests.EventsTest.WebhookHandlersTest
{
    ...
    [TestClass]
    public class FeatureFlightUpdatedWebhookHandlerTest
    {
        ...
        private FeatureFlightUpdatedWebhookHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new FeatureFlightUpdatedWebhookHandler(_mockTenantConfigurationProvider.Object, _mockWebhookTriggerManager.Object, _mockConfiguration, _mockLogger.Object);
        }
