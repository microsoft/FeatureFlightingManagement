...
namespace Microsoft.PS.FlightingService.Core.Tests.EventsTest.WebhookHandlersTest
{
    ...
    [TestClass]
    public class FeatureFlightDeletedWebhookHandlerTest
    {
        ...
        private FeatureFlightDeletedWebhookHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new FeatureFlightDeletedWebhookHandler(_mockTenantConfigurationProvider.Object, _mockWebhookTriggerManager.Object, _mockConfiguration, _mockLogger.Object);
        }
