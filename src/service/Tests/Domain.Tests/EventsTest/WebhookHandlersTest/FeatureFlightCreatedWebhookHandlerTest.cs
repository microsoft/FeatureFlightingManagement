...
namespace Microsoft.PS.FlightingService.Core.Tests.EventsTest.WebhookHandlersTest
{
    ...
    [TestClass]
    public class FeatureFlightCreatedWebhookHandlerTest
    {
        ...
        private FeatureFlightCreatedWebhookHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new FeatureFlightCreatedWebhookHandler(_mockTenantConfigurationProvider.Object, _mockWebhookTriggerManager.Object, _mockConfiguration, _mockLogger.Object);
        }
