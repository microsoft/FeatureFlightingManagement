...
namespace Microsoft.PS.FlightingService.Core.Tests.EventsTest.WebhookHandlersTest
{
    ...
    [TestClass]
    public class FeatureFlightStageActivatedWebhookHandlerTest
    {
        ...
        private FeatureFlightStageActivatedWebhookHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new FeatureFlightStageActivatedWebhookHandler(_mockTenantConfigurationProvider.Object, _mockWebhookTriggerManager.Object, _mockConfiguration, _mockLogger.Object);
        }
        ...
        private FeatureFlightStageActivated GetFeatureFlightStageActivated()
        {
            ...
            return new FeatureFlightStageActivated(featureFlightAggregateRoot,"test activated stage", loggerTrackingIds, "test source");
        }
    }
}
