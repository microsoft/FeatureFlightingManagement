...
namespace Microsoft.PS.FlightingService.Core.Tests.EventsTest.WebhookHandlersTest
{
    ...
    [TestClass]
    public class FeatureFlightDisabledWebhookHandlerTest
    {
        ...
        private FeatureFlightDisabledWebhookHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new FeatureFlightDisabledWebhookHandler(_mockTenantConfigurationProvider.Object, _mockWebhookTriggerManager.Object, _mockConfiguration, _mockLogger.Object);
        }

        [TestMethod]
        public async Task Handle_ShouldTriggerWebhook()
        {
            var testEvent = GetFeatureFlightDisabled();
        ...
        private FeatureFlightDisabled GetFeatureFlightDisabled()
        {
